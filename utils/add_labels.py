...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate new text files with all labels: old & new"
    )
    parser.add_argument(
        "object_labels_path",
        type=str,
        help=("Full path to the directory containing existing labels (object)."),
    )
    parser.add_argument(
        "no_object_labels_path",
        type=str,
        help=("Full path to the directory containing new labels (no object)."),
    )
    parser.add_argument(
        "target_labels_path",
        type=str,
