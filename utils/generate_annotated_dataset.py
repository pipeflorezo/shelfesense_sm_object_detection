...
def generate_dataset():
    ...
    labels_train = pd.read_csv(
        os.path.join(LABELS_PATH, "annotations_train.csv"), names=col_names
    )
    labels_val = pd.read_csv(
        os.path.join(LABELS_PATH, "annotations_val.csv"), names=col_names
    )
    labels_test = pd.read_csv(
        os.path.join(LABELS_PATH, "annotations_test.csv"), names=col_names
    )
